   ...
   !(function (e, t) {
      ...
      var e = {
         ...
         stopTimer: function (t) {
            ...
            void 0 !== n &&
               0 !== n.length &&
               (void 0 === n[n.length - 1].stopTime && (n[n.length - 1].stopTime = new Date()),
               (e.active = !1));
         },
         ...
         getTimeOnPageInSeconds: function (t) {
            return void 0 === e.getTimeOnPageInMilliseconds(t)
               ? void 0
               : e.getTimeOnPageInMilliseconds(t) / 1e3;
         },
         ...
         checkState: function () {
            for (var t = 0; t < e.timeElapsedCallbacks.length; t++)
               e.timeElapsedCallbacks[t].pending &&
                  e.getTimeOnCurrentPageInSeconds() > e.timeElapsedCallbacks[t].timeInSeconds &&
                  (e.timeElapsedCallbacks[t].callback(), (e.timeElapsedCallbacks[t].pending = !1));
            !1 === e.idle && e.currentIdleTimeMs > e.idleTimeoutMs
         ...
         listenForVisibilityEvents: function () {
            void 0 !== document.hidden
               ? ((e.hiddenPropName = 'hidden'), (e.visibilityChangeEventName = 'visibilitychange'))
